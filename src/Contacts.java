...
public class Contacts {
    ...
    private static int getLastPage() {
        try {
            BufferedReader reader = new BufferedReader(new FileReader("last_page_contatos.json"));
    ...
    private static void storeLastPage(int page) {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter("last_page_contatos.json"));
    ...
    private static void insertContactsFromApi(String token) {
